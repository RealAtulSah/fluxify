        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-info">
              <div className="card info-card"><Mail size={20} style={{ color: 'var(--primary)' }} /><div><strong>Email</strong><p>{settings.email || 'hello@fluxifymedia.com'}</p></div></div>
              <div className="card info-card"><Phone size={20} style={{ color: 'var(--accent)' }} /><div><strong>Phone</strong><p>{settings.phone || '+91 98765 43210'}</p></div></div>
              <div className="card info-card"><MapPin size={20} style={{ color: '#10b981' }} /><div><strong>Office</strong><p>{settings.address || 'Noida, Uttar Pradesh'}</p></div></div>
